...
async function main(orgCRN, organisationName, organisationRole, location) {
  try {
    ...
    // process response
    console.log(
      ".....Processing Create Organisation Transaction Response \n\n"
    );
    let newOrg = JSON.parse(dataBuffer.toString());
    console.log(newOrg);
    console.log("\n\n.....Create Organisation Transaction Complete!");
    return newOrg;
  } catch (error) {
    console.log(`\n\n ${error} \n\n`);
