...
/**
 * This is a Node.JS application to deliver car to dealer on the network.
 */
...
async function main(carCRN, dealerCRN, manufacturerCRN) {
  try {
    const carnetContract = await getContractInstance();
    // Create a new Car assert
    console.log(".....Sell car to dealer transaction");
    ...
    // process response
    console.log(".....Processing Sell car Response \n\n");
