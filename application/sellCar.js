...
/**
 * This is a Node.JS application to sell car to customer on the network.
 */
...
async function main(carCRN, dealerCRN, adhaarNumber) {
  try {
    const carnetContract = await getContractInstance();
    // Create a new Car assert
    console.log(".....Sell car to customer transaction");
